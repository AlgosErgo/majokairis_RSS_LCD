...
//=======================================================================
String https_Web_Get(const char* host1, String target_page,
                     char char_tag, String Final_tag, String Begin_tag,
                     String End_tag, String Begin_tag2, String End_tag2, String Paragraph) {
  ...
  ret_str.replace("ニュース・トピックス", ""); // 指定された文字列を空文字列で置き換える
